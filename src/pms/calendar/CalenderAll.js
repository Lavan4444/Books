...
const CalenderAll = () => {
  ...
  const handleClearSearchCalenderAll = () => {
              ...
              <Col md={6} lg={6} className="d-flex align-items-center">
                {selectedTableData.length > 0 && (
                  <>
                    <button
                      type="button"
                      className="btn btn-secondary import-res-btn  ms-1 mainbtn me-1"
                    >
                ...
                <div>
                  <button
                    type="button"
                    className="btn btn-secondary import-res-btn  ms-1 mainbtn mb-1" onClick={handleClearSearchCalenderAll}
                          ...
                          <Row className="">
                            <Col xl={12}>
                              <div className="d-flex justify-content-end">
                                <button
                                  type="button"
                                  class="btn btn-primary  waves-light btn btn-primary me-2 btn-main"
                                >
                                ...
                                <button
                                  color="primary"
                                  className="btn btn-primary  waves-light me-2 cancel-outlinebtn"
                                >
