...
const ImportFromCSVCompanies = () => {
    ...
    const [mappingFields, setMappingFields] = useState([
        { pmsField: 'Company Name', defaultValue: '' },
        { pmsField: 'Website', defaultValue: '' },
        { pmsField: 'Industry', defaultValue: '' },
        { pmsField: 'Company Size', defaultValue: '' },
        { pmsField: 'Email', defaultValue: '' }
    ]);
