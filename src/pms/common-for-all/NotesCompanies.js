...
const NotesCompanies = () => {
    ...
    const [jobs] = useState([
        { id: "Varun Digital Media", title: "www.varundigitalmedia.com", city: "Hyderabad" },
        { id: "Pranathi Software Services", title: "www.pranathiss.com", city: "Bangalore" },
        { id: "Green Ventures", title: "www.greenventures.com", city: "Chennai" },
        { id: "Future Tech", title: "www.futuretech.com", city: "Pune" },
        { id: "Healthify Solutions", title: "www.healthifysolutions.com", city: "Goa" },
    ]);
    ...
    return (
        <React.Fragment>
            <Tooltip target=".notes" content="Companies Notes" position="bottom" style={{ marginTop: "5px" }} />
                        ...
                        <div className="field">
                            ...
                            >
                                ...
                                >
                                    ...
                                    <Column field="id" header="Companies Name" />
                                    <Column field="title" header="Companies Website" />
                                    <Column field="contact" header="City" />
                                </DataTable>
