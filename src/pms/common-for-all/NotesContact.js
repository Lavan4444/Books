...
const NotesContact = () => {
    ...
    const [valueNotes, setValueNotes] = useState(['John Doe']);
    ...
    const [jobs] = useState([
        { id: 1, title: 'Mahesh Kumar Boga, UI/UX Manager', contact: 'mahesh@varundigitalmedia.com' },
        { id: 2, title: 'Salmanuddin, Sales Manager', contact: 'salman@varundigitalmedia.com' },
        { id: 3, title: 'Suresh Reddy, SEO Manager', contact: 'suresh@varundigitalmedia.com' },
        { id: 4, title: 'Aman Kumar, AIML Lead', contact: 'aman@varundigitalmedia.com' },
        { id: 5, title: 'Giri Jalagam, Hr Recruiter', contact: 'giri@varundigitalmedia.com' },
    ]);
    ...
    return (
        <React.Fragment>
            ...
            <Tooltip target=".notes" content="Contacts Notes" position="bottom" style={{ marginTop: "5px" }} />
