...
const NotesJobs = () => {
    ...
    return (
        <React.Fragment>
            <Tooltip target=".import" content="Notes" position="bottom" style={{ marginTop: "5px" }} />

            <button
                type="button"
                className="btn btn-secondary icons-btn me-1 import"
                        ...
                        <div className="field">
                            ...
                            >
                                ...
                                >
                                    ...
                                    <Column field="id" header="Project ID" />
                                    <Column field="title" header="Project Name" />
                                    <Column field="contact" header="Project Manager" />
                                </DataTable>
