...
const WorkType1 = ({
    ...
    // Use prop if available, else fallback to default
    const initialWorkTypes = propInitialWorkTypes || [
        {
            name: 'AI Generator',
            color: '#4c9aff',
            id: 'task',
    ...
    const [file, setFile] = useState(null); // Add missing file state
