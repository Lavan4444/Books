...
const MoreACcontacts = () => {
    ...
    const documentTypes = [
        { name: "Hiring Manager Profiles", code: "INV" },
        { name: " Job Requisition Forms", code: "CTR" },
        { name: "Communication Records", code: "PRP" },
        { name: "Interview Feedback & Evaluation Reports", code: "RPT" },
        { name: "Service Agreements / Contracts", code: "AGR" },
        { name: "Meeting Notes & Interview Schedules", code: "AGR" },
    ];
    ...
    return (
        <React.Fragment>
            ...
            {/* Attachments Dialog for Contacts */}
            <Dialog
                header="Attachments"
            ...
            >
                <Row className="align-items-center">
                    ...
                    <Col lg={12}>
                        <button
                            className="btn btn-primary btn-main mt-2"
                            onClick={() => setIsAttachDocumentVisible(false)}
                        >
                            Submit
                        </button>
                    </Col>
