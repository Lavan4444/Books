...
const ImportFromCSVProject = () => {
    ...
    const [mappingFields, setMappingFields] = useState([
        { atsField: 'Project Code', defaultValue: '' },
        { atsField: 'Project Name', defaultValue: '' },
        { atsField: 'Project Manager', defaultValue: '' },
        { atsField: 'Status', defaultValue: '' },
        // { atsField: 'Location', defaultValue: '' }
    ]);

    const csvColumnOptions = [
        { label: 'Project Code', value: 'First name' },
        { label: 'Project Name', value: 'Middle name' },
        { label: 'Project Manager', value: 'Hiring Manager' },
        { label: 'Status', value: 'Department' },
                    ...
                    <div className="page-title-box actjobbread">
                        <Row>
                            <Col sm={12} md={12} lg={12}>
                                <h1 className="page-title"> Import Projects</h1>
                            </Col>
                        </Row>
                                                    ...
                                                    <Col md={12}>
                                                        ...
                                                        <div className="card p-3">
                                                            ...
                                                            <div className="mb-3 dup-check">
                                                                <label className="mb-2 import-head">Please choose an action to take if a duplicate Project is detected during the upload.</label>
                                                                <div className="mt-2">
                                                                    <div>
                                                                        <input type="radio" id="add_as_a_resume" name="category" value="add_as_a_resume" />
                                                                        <label htmlFor="add_as_a_resume" className="ms-2 mb-0 import-fw">Add as a Project
                                                                        </label>
                                                                        <p className="txt">Select this option to create a new Project in the system.
                                                                        </p>
                                                                    </div>
                                                                    ...
                                                                    <div>
                                                                        ...
                                                                        <p className="txt">Choose this option to replace the existing Projects with the new one.</p>
                                                                    </div>
                                                ...
                                                <Row>
                                                    <Col lg={12}>
                                                        <DataTable value={mappingFields} stripedRows tableStyle={{ minWidth: '50rem' }}>
                                                            <Column field="atsField" header="PMS Fields" style={{ width: '30%' }}
...
export default ImportFromCSVProject;
