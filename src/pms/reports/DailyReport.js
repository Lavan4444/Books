...
const DailyReport = () => {
  ...
  const [filters, setFilters] = useState({
    ...
    employee: { value: null, matchMode: FilterMatchMode.STARTS_WITH },
    project: { value: null, matchMode: FilterMatchMode.STARTS_WITH },
    task: { value: null, matchMode: FilterMatchMode.CONTAINS },
    yesterdays_work: { value: null, matchMode: FilterMatchMode.CONTAINS },
    todays_plan: { value: null, matchMode: FilterMatchMode.CONTAINS },
    blockers: { value: null, matchMode: FilterMatchMode.CONTAINS },
  ...
  const [tableData, setTableData] = useState([
    {
      ...
      project: "PMS App",
      task: "Login API",
      yesterdays_work: "Fixed validation",
      todays_plan: "Integration with UI",
      blockers: "None",
      status: "In Progress",
      hours: 3,
      remarks: "Will finish by EOD",
    },
    {
      id: 2, // Add unique id
      date: "25-Jul-2025",
      ...
      task: "Cart Component",
      yesterdays_work: "Designed cart UI",
      todays_plan: "Implement cart functionality",
      blockers: "Awaiting product API",
      status: "Open",
      hours: 4,
      remarks: "Blocked on backend",
    },
    {
      id: 3, // Add unique id
      date: "26-Jul-2025",
      ...
      task: "Transaction Logs",
      yesterdays_work: "Setup MongoDB schema",
      todays_plan: "Connect to dashboard view",
      blockers: "None",
      status: "In Progress",
      hours: 6,
      remarks: "Expected to complete by today",
    },
    {
      id: 4, // Add unique id
      date: "27-Jul-2025",
      ...
      task: "Supplier Module",
      yesterdays_work: "UI wireframes",
      todays_plan: "Start API design",
      blockers: "No blocker",
      status: "In Progress",
      hours: 5,
    ...
    },
    {
      ...
      task: "Patient Records",
      yesterdays_work: "Integrated profile section",
      todays_plan: "Add edit feature",
      blockers: "Test environment unstable",
      status: "In Progress",
      hours: 4,
      remarks: "Partial progress",
    },
    {
      id: 6, // Add unique id
      date: "29-Jul-2025",
      ...
      yesterdays_work: "Setup calendar UI",
      todays_plan: "Add approval logic",
      blockers: "None",
      status: "Open",
      hours: 3,
      remarks: "Need review by EOD",
    },
    {
      id: 7, // Add unique id
      date: "30-Jul-2025",
      ...
      task: "Wallet Sync",
      yesterdays_work: "Handled sync conflicts",
      todays_plan: "Encrypt data at rest",
      blockers: "Security key config pending",
      status: "Open",
      hours: 6,
      remarks: "Pending infra setup",
    },
    {
      id: 8, // Add unique id
      date: "31-Jul-2025",
      ...
      task: "Quiz Module",
      yesterdays_work: "Built question model",
      todays_plan: "Create question UI",
      blockers: "None",
      status: "In Progress",
      hours: 4,
      remarks: "On track",
    },
    {
      ...
      task: "Order Tracker",
      yesterdays_work: "Setup socket connection",
      todays_plan: "Render real-time updates",
      blockers: "None",
      status: "Done",
      hours: 5,
      remarks: "Tested and working",
    },
    {
      id: 10, // Add unique id
      date: "2-Aug-2025",
      ...
      task: "Device Status",
      yesterdays_work: "Connected with MQTT",
      todays_plan: "Build frontend display",
      blockers: "Slow response from backend",
      status: "In Progress",
      hours: 5,
      remarks: "Backend tuning required",
    },
  ])
  // ...existing code...
      ...
      import("jspdf-autotable").then(() => {
        ...
        const exportColumns = [
          ...
          { title: "Team Collaboration", dataKey: "team_collaboration" },
          {
            ...
            dataKey: "adaptability_innovation",
          },
                ...
                <section className="job-datatable-section">
                  <div className="card1 mt-3 mb-4 actjobsumtable datatable-check">
                    ...
                    >
                      ...
                      />
                      <Column
                        field="yesterdays_work"
                        header="Yesterday’s Work"
                        filter
                        style={{ minWidth: "10rem" }}
                      />
                      <Column
