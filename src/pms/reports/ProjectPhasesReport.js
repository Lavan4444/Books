        ...
        <Container fluid={true}>
          <div className="page-title-box actjobbread mb-0">
                                     ...
                                     <Row className="align-items-center actjobsum">
                                                                <Col sm={6} md={6} lg={8}>
                                                                    <h1 className="page-title">Project Phases Report</h1>
                                                                </Col>
...
export default ProjectPhasesReport
