...
const ResourceUtilization = () => {
 ...
 const [filters, setFilters] = useState({
  ...
  skill: { value: null, matchMode: FilterMatchMode.EQUALS },
  projects_assigned: { value: null, matchMode: FilterMatchMode.CONTAINS },
  project_manager: { value: null, matchMode: FilterMatchMode.CONTAINS },
  total_hours: { value: null, matchMode: FilterMatchMode.EQUALS },
  billable_hours: { value: null, matchMode: FilterMatchMode.EQUALS },
  non_billable_hours: { value: null, matchMode: FilterMatchMode.EQUALS },
  utilization_percent: { value: null, matchMode: FilterMatchMode.CONTAINS },
  bench_status: { value: null, matchMode: FilterMatchMode.CONTAINS },
  skill_avg_util_percent: { value: null, matchMode: FilterMatchMode.CONTAINS },
  project_avg_util_percent: { value: null, matchMode: FilterMatchMode.CONTAINS },
 ...
 const [tableData, setTableData] = useState([
  {
    ...
    projects_assigned: "AI Generator, Resume Parser, Chatbot Assistant",
    ...
    bench_status: "No",
    skill_avg_util_percent: "81.25%",
    project_avg_util_percent: "88.0%",
    comments: "Fully engaged"
  },
  {
    employee_id: "EMP002",
    name: "Priya Sharma",
    skill: "QA Engineer",
    projects_assigned: "AI Generator, Chatbot Assistant",
    project_manager: "Ashok Kumar",
    total_hours: 160,
    billable_hours: 120,
    non_billable_hours: 40,
    utilization_percent: "75.0%",
    bench_status: "No",
    skill_avg_util_percent: "68.75%",
    project_avg_util_percent: "85.9%",
    comments: "Moderate load"
  },
  {
    employee_id: "EMP003",
    name: "Arjun Patel",
    skill: "UI/UX Designer",
    projects_assigned: "Resume Parser, AI Generator, Chatbot Assistant",
    project_manager: "Mahesh Kumar Bhoga",
    total_hours: 160,
    billable_hours: 0,
    non_billable_hours: 160,
    utilization_percent: "0.0%",
    bench_status: "Yes",
    skill_avg_util_percent: "56.25%",
    project_avg_util_percent: "-",
    comments: "Reskill / deploy ASAP"
  },
  {
    employee_id: "EMP004",
    name: "Sneha Joshi",
    skill: "Backend Developer",
    projects_assigned: "Chatbot Assistant, Resume Parser, AI Generator",
    project_manager: "Sathish Kumar",
    total_hours: 160,
    billable_hours: 0,
    non_billable_hours: 160,
    utilization_percent: "0.0%",
    ...
    skill_avg_util_percent: "68.75%",
    project_avg_util_percent: "-",
    comments: "Training underway"
  },
  {
    employee_id: "EMP005",
    name: "Rohan Nair",
    skill: "Data Engineer",
    projects_assigned: "Project B, Resume Parser, Chatbot Assistant",
    project_manager: "Sathish Kumar",
    total_hours: 160,
    billable_hours: 145,
    non_billable_hours: 15,
    utilization_percent: "90.6%",
    bench_status: "No",
    skill_avg_util_percent: "90.6%",
    project_avg_util_percent: "72.0%",
    comments: "Monitor for burnout risk"
  },
  {
  employee_id: "EMP006",
  name: "Divya Menon",
  skill: "Backend Developer",
  projects_assigned: "E-commerce Platform, Chatbot Assistant, Resume Parser",
  project_manager: "Sathish Kumar",
  total_hours: 160,
  billable_hours: 135,
  ...
  bench_status: "No",
  skill_avg_util_percent: "78.0%",
  project_avg_util_percent: "86.5%",
  comments: "Performing well"
},
{
  employee_id: "EMP007",
  name: "Karan Verma",
  skill: "DevOps Engineer",
  projects_assigned: "Mobile Banking App, Resume Parser, Project C",
  project_manager: "Neha Sethi",
  total_hours: 160,
  billable_hours: 125,
  non_billable_hours: 35,
  utilization_percent: "78.1%",
  bench_status: "No",
  skill_avg_util_percent: "73.4%",
  project_avg_util_percent: "81.2%",
  comments: "Slightly under-utilized"
},
{
  employee_id: "EMP008",
  name: "Ayesha Khan",
  skill: "Full Stack Developer",
  projects_assigned: "AI Generator, Smart Home Dashboard, Resume Parser",
  project_manager: "Mahesh Kumar Bhoga",
  total_hours: 160,
  billable_hours: 150,
  ...
  bench_status: "No",
  skill_avg_util_percent: "89.2%",
  project_avg_util_percent: "91.4%",
  comments: "Excellent contributor"
},
{
  employee_id: "EMP009",
  name: "Nikhil Rao",
  skill: "Business Analyst",
  projects_assigned: "Inventory Management System, Food Delivery App, Resume Parser",
  project_manager: "Ravi Teja",
  total_hours: 160,
  billable_hours: 110,
  non_billable_hours: 50,
  utilization_percent: "68.8%",
  bench_status: "No",
  skill_avg_util_percent: "65.0%",
  project_avg_util_percent: "70.3%",
  comments: "Needs realignment"
},
{
  employee_id: "EMP010",
  name: "Meera Desai",
  skill: "Project Coordinator",
  projects_assigned: "Online Learning Portal, AI Generator, Smart Home Dashboard",
  project_manager: "Raj Mehta",
  total_hours: 160,
  billable_hours: 130,
  non_billable_hours: 30,
  utilization_percent: "81.3%",
  bench_status: "No",
  skill_avg_util_percent: "77.5%",
  project_avg_util_percent: "83.1%",
  comments: "Balanced load"
}
        ...
        <Container fluid={true}>
          <div className="page-title-box actjobbread mb-0">
                                     ...
                                     <Row className="align-items-center actjobsum">
                                                                <Col sm={6} md={6} lg={8}>
                                                                    <h1 className="page-title">Consolidated Resource Utilization Report</h1>
                                                                </Col>
                ...
                <section className="job-datatable-section">
                  <div className="card1 mt-3 mb-4 actjobsumtable datatable-check">
                    ...
                    >
                      ...
                      />
                     <Column field="employee_id" header="Employee ID" filter sortable  style={{ minWidth: "12rem", fontWeight: "bold" }} />
  <Column field="name" header="Name" filter sortable style={{ minWidth: "12rem"}}/>
  <Column field="skill" header="Skill" filter sortable style={{ minWidth: "12rem"}}/>
  <Column field="projects_assigned" header="Projects Assigned" filter sortable style={{ minWidth: "12rem"}}/>
  <Column field="project_manager" header="Project Manager Name" filter sortable  style={{ minWidth: "14rem"}}/>
  <Column field="total_hours" header="Total Hrs (Month)" filter sortable style={{ minWidth: "11rem"}}/>
  <Column field="billable_hours" header="Billable Hrs" filter sortable style={{ minWidth: "11rem"}}/>
  <Column field="non_billable_hours" header="Non-Billable Hrs" filter sortable style={{ minWidth: "11rem"}}/>
  <Column field="utilization_percent" header="Utilization %" filter sortable style={{ minWidth: "11rem"}}/>
  <Column field="bench_status" header="Bench Status" filter sortable style={{ minWidth: "11rem"}}/>
  <Column field="skill_avg_util_percent" header="Skill Avg Util %" filter sortable style={{ minWidth: "11rem"}}/>
  <Column field="project_avg_util_percent" header="Project Avg Util %" filter sortable style={{ minWidth: "11rem"}}/>
  <Column field="comments" header="Comments" filter sortable style={{ minWidth: "11rem"}}/>
