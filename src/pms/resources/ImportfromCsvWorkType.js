                    ...
                    <div className="page-title-box actjobbread">
                        <Row>
                            <Col sm={12} md={12} lg={12}>
                                <h1 className="page-title"> Import Work Type</h1>
                            </Col>
                        </Row>
                                                ...
                                                <Row>
                                                    <Col md={12}>
                                                        ...
                                                        <div className="card p-3 dup-check">
                                                            ...
                                                            <div className="mb-3">
                                                                <label className="mb-2 import-head">Please choose an action to take if a duplicate Work Type is detected during the upload.</label>
                                                                <div className="mt-2">
                                                                    <div>
                                                                        <input type="radio" id="add_as_a_resume" name="category" value="add_as_a_resume" />
                                                                        <label htmlFor="add_as_a_resume" className="ms-2 mb-0 import-fw">Add as a Work Type
                                                                        </label>
                                                                        <p className="txt">Select this option to create a new Work Type in the system.
                                                                        </p>
                                                                    </div>
                                                                    ...
                                                                    <div>
                                                                        ...
                                                                        <p className="txt" >Choose this option to replace the existing Work Type with the new one, moving the old Work Type to the documents section.</p>
                                                                    </div>
...
export default ImportfromCsvWorkType;